...
mkdir -p "$destination"
for filename in manifest.json Panel.qml theme_styles.py agents.py opencode_images.py opencode-images.mjs opencode-image-provider.mjs harnesses.py security.py files.py errors.py processes.py storage.py desktop.py policy.xml theme-styles LICENSE; do
